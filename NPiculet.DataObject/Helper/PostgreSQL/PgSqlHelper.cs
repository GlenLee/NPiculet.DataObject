...
{
	public class PgSqlHelper : AbstractDbHelper
	{
		#region 初始化

		public PgSqlHelper(ServerType type, string connString)
		...
		{
			return new PgSqlHelper(base.CurrentConnectionType, base.CurrentConnectionString);
		}
